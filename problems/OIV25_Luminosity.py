...
#output_file = '/net/maedoc.ap.dias.ie/maedoc/home_cr/arun/Desktop/plots/line_luminosity_OIV25_equi.txt'  # Output file for results
...
output_file = '/home/tony/Desktop/wind-wind/line_luminosity_OIV25.txt'  # Output file for results

filebase = 'e7_WRwind_d1l5n256_v1500'  # Base name of the silo files


# Set up the ion and line emission parameters
O3P_pion_ion = 'O3+'  # The ion of interest (Oxygen VI)
O3P_lines = [2.589332e+05]  # Emission line(s) of interest
