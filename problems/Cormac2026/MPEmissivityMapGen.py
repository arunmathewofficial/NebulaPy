...
if __name__ == "__main__":
    ...
    silo_dir = '/home/tony/Desktop/Cormac_test/mpv10-wind-test'
    filebase = 'e7_WRwind_d1l5n256_v0750'
    start_time = 99.8  # kyr
    finish_time = 100  # kyr
    out_frequency = None  # Use all available outputs
    time_unit = 'kyr'
    # Output configuration
    output_dir = '/home/tony/Desktop/Cormac_test/test_image'
    filename = filebase + '_cormac.h5'
    ...
    pion_geometry = pion.geometry_container
    N_grid_level = pion_geometry['Nlevel']
    mesh_edges_min = pion_geometry['edges_min']
    mesh_edges_max = pion_geometry['edges_max']
    coordinate_system = pion_geometry['coordinate_sys']
    grid_mask = pion_geometry['mask']
    shell_volume = []
    cell_volume = []
    radial_array = []
    ...
    with h5py.File(outfile, "w") as f:
        ...
        for group, items in datasets.items():
