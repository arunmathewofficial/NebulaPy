...
if __name__ == "__main__":
    ...
    with open(ism_outfile, "w") as ism_file:
        ...
        ism_file.write("#Task: Multiprocessing for Computing the Temporal Evolution of Hα, Hβ Luminosities\n\n")
    ...
    with open(grid_outfile, "w") as grid_file:
        ...
        grid_file.write("#Task: Multiprocessing for Computing the Temporal Evolution of Hα, Hβ Luminosities\n\n")
