...
output_dir = '/home/tony/Desktop/multi-ion-bowshock/sim-output/AllSpectralLines'  # Change as needed
silo_dir = '/home/tony/Desktop/multi-ion-bowshock/high-res-silo-200kyr' # Change as needed
...
with open(outfile, "w") as file:
    ...
    file.write("# This dataset provides a list of all spectral lines and their\n")
    ...
    file.write("# - Column 3: Transition probability (measured in s⁻¹)\n")
    file.write("# - Column 4: Lower transition level\n")
    file.write("# - Column 5: Upper transition level\n\n")
...
for step, silo_instant in enumerate(batched_silos):
    ...
    for ion in ion_list:
        ...
        dominant_lines = species_line_emission.get_species_dominant_lines(
            ...
            cell_volume=cell_volume, grid_mask=grid_mask,
        )

        if 'lines' not in dominant_lines:
            with open(outfile, "a") as file:
                file.write(f"No line emission associated with {dominant_lines['spectroscopic']}\n\n")
                print(" skipping ...")
        else:
            ...
            dataframe_avalue = pd.DataFrame({'Avalue': dominant_lines['Avalue']})
            dataframe_lower = pd.DataFrame({'Lower': dominant_lines['Lower']})
            dataframe_upper = pd.DataFrame({'Upper': dominant_lines['Upper']})

            final_dataframe = pd.concat([dataframe_lines, dataframe_luminosity, dataframe_avalue,
                                         dataframe_lower, dataframe_upper], axis=1)
