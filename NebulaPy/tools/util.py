...
def nebula_info(infoMessage):
    ...
    CYAN = "\033[96m"
    RESET = "\033[0m"
    print(f'{CYAN} Info: {infoMessage}{RESET}')

######################################################################################
# Nebula computing comment
######################################################################################
def nebula_computing_comment(comment):
    """
...
# Nebula done comment
######################################################################################
def nebula_done_comment(comment):
    """
    Custom completion status display function.
    :param comment: Optional status message.
    """
    GRAY = "\033[90m"
    RESET = "\033[0m"
